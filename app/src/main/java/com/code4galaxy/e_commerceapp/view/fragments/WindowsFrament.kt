...
import com.code4galaxy.e_commerceapp.databinding.FragmentWindowsBinding

class WindowsFrament: Fragment() {
    ...
    override fun onCreateView(
        ...
        savedInstanceState: Bundle?
         ...
         binding = FragmentWindowsBinding.inflate(inflater,container,false)
